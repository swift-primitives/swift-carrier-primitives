...
@Suite("String+Carrier")
struct StringCarrierTests {
    @Suite struct Unit {}
...
extension StringCarrierTests.Unit {
...
extension StringCarrierTests.`Edge Case` {
...
extension StringCarrierTests.Integration {
