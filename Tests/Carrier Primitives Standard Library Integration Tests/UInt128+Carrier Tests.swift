...
@Suite("UInt128+Carrier")
struct UInt128CarrierTests {
    @Suite struct Unit {}
...
extension UInt128CarrierTests.Unit {
...
extension UInt128CarrierTests.`Edge Case` {
...
extension UInt128CarrierTests.Integration {
