...
`Carrier<Underlying>` and `RawRepresentable` look structurally similar — one associated type, one accessor, one init. The superficial resemblance invites the question "why not just use `RawRepresentable`?" This article answers it with a decision tree; the full nine-dimension analysis lives in `Research/carrier-vs-rawrepresentable-comparative-analysis.md`.
...
See `Research/carrier-vs-rawrepresentable-comparative-analysis.md` §"Why not refine" and §"Why not subsume" for the full argument.

## Further reading

The full nine-dimension analysis backing this decision tree lives in `Research/carrier-vs-rawrepresentable-comparative-analysis.md` (DECISION, 2026-04-24).
